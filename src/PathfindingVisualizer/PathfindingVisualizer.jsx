    ...
    if (!this.state.isRunning) {
      ...
      switch (algo) {
        case 'Dijkstra':
          ...
          var time = (end - start)
          alert('Execution time in ms: ' + time); 
          break;
        case 'BFS':
          var startBfs = new Date().getTime()
          visitedNodesInOrder = bfs(grid, startNode, finishNode);
          var endBfs= new Date().getTime()
          var timeBfs =(endBfs - startBfs)
          alert('Execution time in ms: ' + timeBfs); 
          break;
        case 'DFS':
          var startDfs=new Date().getTime();
          visitedNodesInOrder = dfs(grid, startNode, finishNode);
          var endDfs = new Date().getTime();
          var timeDfs = (endDfs - startDfs)
          alert('Execution time in ms: ' + timeDfs); 
          break;
        default:
